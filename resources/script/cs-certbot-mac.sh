...
#
gsed "s/#MTM_SUBDOMAIN/$MTM_SUBDOMAIN/g" ./config-template/LocalSettings.php > ./config/LocalSettings.php
gsed -i "s|#YOUR_FQDN|$FQDN|g" ./config/LocalSettings.php
gsed -i "s|#KCK_SUBDOMAIN|$KCK_FQDN|g" ./config/LocalSettings.php
#
gsed "s/#YOUR_DOMAIN/$YOUR_DOMAIN/g" ./config-template/default.yml > ./config/default.yml
gsed -i "s|#YOUR_EMAIL_ADDRESS|$YOUR_EMAIL_ADDRESS|g" ./config/default.yml
gsed -i "s|#DEFAULT_TRANSPORT|$DEFAULT_TRANSPORT|g" ./config/default.yml
#
